...
public class UriHttpAsyncRequestHandlerMapper implements HttpAsyncRequestHandlerMapper {
    ...
    private final UriPatternMatcherHC4<HttpAsyncRequestHandler<?>> matcher;

    protected UriHttpAsyncRequestHandlerMapper(final UriPatternMatcherHC4<HttpAsyncRequestHandler<?>> matcher) {
        super();
        this.matcher = Args.notNull(matcher, "Pattern matcher");
    }

    public UriHttpAsyncRequestHandlerMapper() {
        this(new UriPatternMatcherHC4<HttpAsyncRequestHandler<?>>());
    }
