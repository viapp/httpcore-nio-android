...
import org.apache.http.params.CoreConnectionPNamesHC4;
    ...
    static IOReactorConfig convert(final int workerCount, final HttpParams params) {
        ...
        return IOReactorConfig.custom()
            ...
            .setIoThreadCount(workerCount)
                .setSoTimeout(params.getIntParameter(CoreConnectionPNamesHC4.SO_TIMEOUT, 0))
                .setConnectTimeout(params.getIntParameter(CoreConnectionPNamesHC4.CONNECTION_TIMEOUT, 0))
                .setSoTimeout(params.getIntParameter(CoreConnectionPNamesHC4.SO_TIMEOUT, 0))
                .setSoReuseAddress(params.getBooleanParameter(CoreConnectionPNamesHC4.SO_REUSEADDR, false))
                .setSoKeepAlive(params.getBooleanParameter(CoreConnectionPNamesHC4.SO_KEEPALIVE, false))
                .setSoLinger(params.getIntParameter(CoreConnectionPNamesHC4.SO_LINGER, -1))
                .setTcpNoDelay(params.getBooleanParameter(CoreConnectionPNamesHC4.TCP_NODELAY, true))
            .build();
    }
