...
import org.apache.http.params.CoreProtocolPNamesHC4;
...
CoreProtocolPNamesHC4.HTTP_MALFORMED_INPUT_ACTION);
            final CodingErrorAction unmappableCharAction = (CodingErrorAction) params.getParameter(
CoreProtocolPNamesHC4.HTTP_UNMAPPABLE_INPUT_ACTION);
